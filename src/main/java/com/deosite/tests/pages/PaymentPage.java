...
public class PaymentPage {
    ...
    public static Target PAYPAL_PAYMENT_CHECKBOX = Target.the("Card payment checkbox").locatedBy("//div[@data-test='paypal_express']");
    ...
    public static Target DELETE_PRODUCT_BUTTON_ON_PAYMENT_PAGE_AFTER_ORDER =
            Target.the("Delete product button on payment page").locatedBy("(//button[@data-test='delete-product-minicart'])[2]");
