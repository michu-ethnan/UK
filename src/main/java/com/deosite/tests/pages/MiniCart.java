...
public class MiniCart {
    ...
    public static Target EMPTY_CART_MESSAGE = Target.the("Empty cart message").locatedBy("//*[@id=\"__layers__\"]/div/div[2]//div[2]/div/span[2]");
    ...
    public static Target MINICART_HEADER = Target.the("Minicart header").locatedBy("//*[@id=\"__layers__\"]/div/div[2]/div/div[2]/div/div/div/div[1]/div[2]/div/span");
    public static Target CLOSE_CART_BUTTON = Target.the("Close cart button").locatedBy("(//div[@id=\"__layers__\"]//button[1])[1]");
    public static Target TOTAL_SUM = Target.the("Total sum in minicart").locatedBy("//*[@id=\"__layers__\"]/div/div[2]//div[2]/span/span[1]");
