...
import com.deosite.tests.questions.account.OrderNumber;
...
public class SeeOrder {
    ...
    public void that_actor_is_in_my_account(String actor) {
        theActorCalled(actor).wasAbleTo(
                ...
                Open.loginPage(),
                FillInLoginForm.type("login to see order"),
    ...
    public void actor_goes_to_my_orders_tab() {
        theActorInTheSpotlight().attemptsTo(
                WaitUntil.the(MY_ORDERS_BUTTON, isPresent()),
    ...
    public void he_should_see_the_details_of_this_order() {
        theActorInTheSpotlight().should(seeThat(OrderNumber.isDisplayed()));
